    ...
    <>
      ...
      <Card className={`${userCheckStyle} relative flex items-start justify-start md:w-[75%] w-[85%] gap-3 p-3 min-h-[100px] max-h-[200px] overflow-auto`}>
        ...
        <CardContent className="p-0">
          <CardTitle className="max-w-[80%] md:max-w-[100%] sm:truncate">{comment.author?.username} </CardTitle>

          {postOwner ? <span className='scale-[0.7] absolute px-2 text-sm font-bold rounded-md py-[0.5px] right-1 top-2 bg-slate-400 text-slate-600'>Author</span> : null}
