...
const MakeaPost = () => {
  ...
  >
    ...
    <span
      className="capitalize pointer-events-none absolute opacity-0 group-hover:opacity-100 p-2 dark:text-slate-400  text-slate-300  bg-slate-700 dark:bg-slate-600 rounded-lg group-hover:text-sm group-hover:-translate-y-14 duration-700 w-fit"
    >
      make_A_Post
    </span>
  </button>
